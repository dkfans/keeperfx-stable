...
struct GuiButtonInit main_menu_buttons[] = {
  ...
  { LbBtnT_RadioBtn,   BID_INFO_TAB, 0, 0,    gui_set_menu_mode,           NULL,  NULL,      GMnu_QUERY,   0, 154,   0, 154, 28, 34, gui_draw_tab,                      7, GUIStr_InformationPanelDesc,0,{(long)&info_tag},     0, menu_tab_maintain },
  { LbBtnT_RadioBtn,   BID_ROOM_TAB, 0, 0,    gui_set_menu_mode,           NULL,  NULL,       GMnu_ROOM,  28, 154,  28, 154, 28, 34, gui_draw_tab,                      9, GUIStr_RoomPanelDesc,       0,{(long)&room_tag},     0, menu_tab_maintain },
  { LbBtnT_RadioBtn,  BID_SPELL_TAB, 0, 0,    gui_set_menu_mode,           NULL,  NULL,      GMnu_SPELL,  56, 154,  56, 154, 28, 34, gui_draw_tab,                     11, GUIStr_ResearchPanelDesc,   0,{(long)&spell_tag},    0, menu_tab_maintain },
  { LbBtnT_RadioBtn,  BID_MNFCT_TAB, 0, 0,    gui_set_menu_mode,           NULL,  NULL,       GMnu_TRAP,  84, 154,  84, 154, 28, 34, gui_draw_tab,                     13, GUIStr_WorkshopPanelDesc,   0,{(long)&trap_tag},     0, menu_tab_maintain },
  { LbBtnT_RadioBtn, BID_CREATR_TAB, 0, 0,    gui_set_menu_mode,           NULL,  NULL,   GMnu_CREATURE, 112, 154, 112, 154, 28, 34, gui_draw_tab,                     15, GUIStr_CreaturePanelDesc,   0,{(long)&creature_tag}, 0, menu_tab_maintain },
...
struct GuiButtonInit query_menu_buttons[] = {
  ...
  {LbBtnT_ToggleBtn, BID_QRY_IMPRSN, 0, 0, gui_set_tend_to,    NULL,        NULL,               1,  36, 190,  36, 190, 32, 26, gui_area_flash_cycle_button,     350, GUIStr_CreatureImprisonDesc, 0,{(long)&game.my.creatures_tend_imprison}, 1, maintain_prison_bar },
  {LbBtnT_ToggleBtn,   BID_QRY_FLEE, 0, 0, gui_set_tend_to,    NULL,        NULL,               2,  74, 190,  74, 190, 32, 26, gui_area_flash_cycle_button,     346, GUIStr_CreatureFleeDesc,     0,{(long)&game.my.creatures_tend_flee}, 1, NULL },
